...
const ProfileCardLoader = () => {
  return (
    <div className="text-center card-body bg-white border" style={{ height: 229 }}>
      ...
      <TextRow color="#E0E0E0" style={{ width: 200, height: 20 }} className="mt-3 ml-auto mr-auto" />
      <RectShape color="#E0E0E0" style={{ width: 80, height: 30 }} className="mt-3 ml-auto mr-auto" />
    </div>
  );
};
